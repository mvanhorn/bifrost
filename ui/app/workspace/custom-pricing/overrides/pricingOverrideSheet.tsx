							...
							<>
								...
								{form.scopeRoot === "virtual_key" && (
									<div className="space-y-2">
										...
										>
											<SelectTrigger data-testid="pricing-override-virtual-key-select" className="w-full" disabled={isVirtualKeysLoading || !!virtualKeysError}>
								...
								<div className="grid grid-cols-2 gap-2">
									<div className="space-y-2">
										...
										>
											<SelectTrigger data-testid="pricing-override-provider-select" className="w-full" disabled={isProvidersLoading || !!providersError}>
												{isProvidersLoading ? (
